...
namespace Railken\Laravel\Manager\Tests\Core\Article\Attributes\Description;


use Railken\Laravel\Manager\Contracts\EntityContract;
use Railken\Laravel\Manager\ModelAttribute;
use Railken\Laravel\Manager\Traits\AttributeValidateTrait;
use Railken\Laravel\Manager\Tests\Core\Article\Attributes\Description\Exceptions as Exceptions;
...
class DescriptionAttribute extends ModelAttribute
{
    ...
    protected $permissions = [
        Tokens::PERMISSION_FILL => 'article.attributes.description.fill',
        Tokens::PERMISSION_SHOW => 'article.attributes.description.show'
    ];
